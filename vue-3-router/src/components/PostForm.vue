...
export default {
    ...
    // watch: {
    //     post: { // глубокое отслеживание объекта для получения срабатывания каждый раз при изменении поля, если создать просто функцию - срабатывает только один раз при рендеринге
    //         handler(newVal) {
    //             console.log(newVal)
    //         },
    //         deep: true
